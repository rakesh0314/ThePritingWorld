...
<header class="header-area clearfix header-hm9 transparent-bar">
                        ...
                        <div class="same-style cart-wrap">
                            ...
                            <div class="shopping-cart-content">
                                <ul>
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="<?= base_url() ?>assets/enduser/assets/img/cart/cart-1.png"></a>
                                        </div>
                                    ...
                                    <li class="single-shopping-cart">
                                        <div class="shopping-cart-img">
                                            <a href="#"><img alt="" src="<?= base_url() ?>assets/enduser/assets/img/cart/cart-2.png"></a>
                                        </div>
                                        <div class="shopping-cart-title">
                                            <h4><a href="#">T- Shart & Jeans </a></h4>
                                            <h6>Qty: 02</h6>
                                ...
                                <div class="shopping-cart-btn btn-hover text-center">
                                    <a class="default-btn" href="<?= base_url() ?>Cart">view cart</a>
                                    <a class="default-btn" href="<?= base_url() ?>Checkout">checkout</a>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="header-bottom sticky-bar1 sticky-bar header-res-padding header-padding-2">
        <div class="container">
            <div class="row">
