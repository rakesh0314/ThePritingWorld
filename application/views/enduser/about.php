        ...
        <div class="row">
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="#"><img src="<?= base_url() ?>assets/enduser/assets/img/banner/banner-1.jpg" alt=""></a>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="#"><img src="<?= base_url() ?>assets/enduser/assets/img/banner/banner-2.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Plo Bag</h3>
            ...
            <div class="col-lg-4 col-md-4">
                <div class="single-banner mb-30">
                    <a href="#"><img src="<?= base_url() ?>assets/enduser/assets/img/banner/banner-3.jpg" alt=""></a>
                    <div class="banner-content">
                        <h3>Sunglass</h3>
                        <h4>Starting at <span>$79.00</span></h4>
                        <a href="#"><i class="fa fa-long-arrow-right"></i></a>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-wrapper mb-30">
                    <div class="team-img">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/enduser/assets/img/team/team-1.jpg" alt="">
                        </a>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-wrapper mb-30">
                    <div class="team-img">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/enduser/assets/img/team/team-3.jpg" alt="">
                        </a>
                        <div class="team-action">
                            <a class="facebook" href="#">
                                <i class="fa fa-facebook"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-wrapper mb-30">
                    <div class="team-img">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/enduser/assets/img/team/team-2.jpg" alt="">
                        </a>
                        <div class="team-action">
                            <a class="facebook" href="#">
                                <i class="fa fa-facebook"></i>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="team-wrapper mb-30">
                    <div class="team-img">
                        <a href="#">
                            <img src="<?= base_url() ?>assets/enduser/assets/img/team/team-4.jpg" alt="">
                        </a>
                        <div class="team-action">
                            <a class="facebook" href="#">
                                <i class="fa fa-facebook"></i>
